  ...
  return (
    <PageTemplate>
      <Helmet>
        ...
        <meta name="description" content="Discover how Secure Tech Solutions streamlines IT asset management with secure, organized tracking of hardware, software, and licensing to enhance visibility and reduce risk." />
      </Helmet>
      <div className="overflow-hidden bg-white py-24 sm:py-32"> <div className="mx-auto max-w-7xl px-6 lg:px-8">
