      ...
      <main className="isolate">
        ...
        <div className="mx-auto w-full px-8 lg:px-12">
          <div className="flex justify-center w-full h-24">
            <div className="h-full mx-auto lg:mx-48 xl:mx-96 w-full inline-flex flex-nowrap overflow-hidden [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-200px),transparent_100%)] [&_img]:max-w-60">
