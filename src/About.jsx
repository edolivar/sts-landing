              ...
              <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                <div className="relative w-full lg:max-w-xl lg:shrink-0 xl:max-w-2xl">
                  ...
                  <p className="mt-8 text-pretty text-lg font-medium text-gray-500 sm:max-w-md sm:text-xl/8 lg:max-w-none">
                    ...
                    cutting-edge technology solutions. For over 30 years, we
                    have proudly supported businesses across the U.S.,
                    empowering them to grow and stay secure. Our comprehensive
                    range of services, backed by expert knowledge, ensures that
                    we are your trusted partner in achieving sustainable
                    business success.
                  </p>
                </div>
            ...
            <div className="mt-6 flex flex-col gap-x-8 gap-y-20 lg:flex-row">
              <div className="lg:w-full lg:max-w-2xl lg:flex-auto">
                <p className="text-xl/8 text-gray-600">
                  ...
                  partnerships built on trust and excellence. We are dedicated
                  to providing comprehensive consulting services, from turnkey
                  network installations to the maintenance and support of
                  existing systems, tailored to meet the unique needs of each
                  client.
                </p>
                <p className="mt-10 max-w-xl text-base/7 text-gray-700">
                  ...
                  points for small and medium-sized businesses. At the core of
                  our mission is a dedication to building lasting relationships
                  with our clients, helping them grow and succeed in an
              ...
              <div className="lg:flex lg:flex-auto lg:justify-center">
                <dl className="w-64 space-y-8 xl:w-80">
                  {stats.map((stat) => (
                    ...
                    >
                      <dt className="text-base/7 text-stsLight">
                        {stat.label}
                      </dt>
